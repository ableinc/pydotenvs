import click, os
from pyenv.main import load_env_cli, load_env_object, clear_env
from pyenv.version import __version__
...
@click.option('-a', '--autoclose', default=False, type=click.BOOL, help='Auto-close StringIO object')
...
def client(envpath, command, loadobj, stringio, autoclose, verbose, ignore):
	if stringio:
		stringObj = load_env(env_path=envpath, stringIO=stringio, auto_close=autoclose, verbose=verbose)  # without auto close, you're resposible for closing StringIO object
